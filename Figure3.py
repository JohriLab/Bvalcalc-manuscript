## See code also in deprecated/plotB_figures_200kb.py, I updated cli.py to call this function instead of plotB.py
...
def plotB_figures_200kb(b_values_input, caller, output_path, quiet, gene_ranges=None, neutral_only=False, rec_rates=None):
    ...
    # chr_200kb AKA 200kb Genome (basic model supplementary figure)
    ...
    # chr_200kb_recmap AKA 200kb Rec Map (main Figure 3)
